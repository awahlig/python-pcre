...
tests = [
    ...
    # PCRE: PCRE interprets "\119" as group 119, not group 11 + "9"
    ...
    # PCRE: these have special meaning, syntax error
    ...
    ('a.*b', 'acc\nccb', FAIL),
    ('a.{4,5}b', 'acc\nccb', FAIL),
    # PCRE: depends on build and compilation flags
    #('a.b', 'a\rb', SUCCEED, 'found', 'a\rb'),
    # PCRE: (?s) must be before the dot
    #('a.b(?s)', 'a\nb', SUCCEED, 'found', 'a\nb'),
...
123""", SUCCEED, 'found', 'abc'),
    ...
    # PCRE: some have special meaning, syntax error
    ...
    # PCRE: verbosity is enabled at the point where the flag is, so this fails
...
try:
    ...
    (r'(*UCP)\b.\b', u, SUCCEED, 'found', u),
    (r'(*UCP)\w', u, SUCCEED, 'found', u),
    ])
